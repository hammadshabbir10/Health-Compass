      ...
      <main style={{ maxWidth: '980px', margin: '0 auto', padding: '2.5rem 2rem 4rem' }}>
        ...
        >
          <div style={{ display: 'grid', gap: '1rem', alignItems: 'center', gridTemplateColumns: '1.4fr 1fr' }}>
            <div>
              <h2 style={{ margin: 0, fontSize: '2rem' }}>{test?.title || 'Memory Recall Test'}</h2>
              <p style={{ marginTop: '0.6rem', color: '#cbd5f5', lineHeight: 1.7 }}>
                This section evaluates short-term recall and attention patterns. It helps distinguish
                normal aging from memory changes that may require follow-up.
              </p>
            </div>
            <div
              style={{
        ...
        {!test && (
          ...
          >
            <div style={{ fontWeight: 600, fontSize: '1.05rem' }}>Memory test is not ready yet.</div>
