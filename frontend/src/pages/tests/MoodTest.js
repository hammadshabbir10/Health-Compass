      ...
      <main style={{ maxWidth: '980px', margin: '0 auto', padding: '2.5rem 2rem 4rem' }}>
        ...
        >
          <div style={{ display: 'grid', gap: '1rem', alignItems: 'center', gridTemplateColumns: '1.4fr 1fr' }}>
            <div>
              <h2 style={{ margin: 0, fontSize: '2rem' }}>{test?.title || 'Mood & Wellbeing Test'}</h2>
              <p style={{ marginTop: '0.6rem', color: '#cbd5f5', lineHeight: 1.7 }}>
                This section explores mood, stress, and emotional wellbeing patterns to detect changes that
        ...
        >
          ...
          <ul style={{ margin: 0, paddingLeft: '1.1rem', color: '#cbd5f5', lineHeight: 1.7 }}>
            <li>Global mood patterns help explain changes in attention and motivation.</li>
            <li>Emotional wellbeing checks separate stress from persistent low mood.</li>
            <li>Daily function impact highlights when support or follow-up is needed.</li>
          </ul>
        </div>
        ...
        {!test && (
          ...
          >
            <div style={{ fontWeight: 600, fontSize: '1.05rem' }}>Mood test is not ready yet.</div>
